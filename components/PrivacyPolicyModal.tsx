                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-sm">Your bank statement file is processed entirely in your browser. No file is uploaded to our servers.</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-cyan-300">Direct AI Processing</h4>
                      <p className="text-slate-300 text-sm">File content is sent directly from your browser to Google Gemini AI using your API key.</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-sm">Extracted transaction data is displayed in your browser and never stored on our servers.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-900/30 border border-green-700 rounded-lg p-4">
                <ul className="text-slate-300 space-y-2">
                  ...
                  <li className="flex items-center">
                    ...
                    Your transaction data or financial information
                  </li>
                  <li className="flex items-center">
                    <svg className="w-4 h-4 mr-2 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="mb-6">
              ...
              <div className="bg-blue-900/30 border border-blue-700 rounded-lg p-4">
                <p className="text-slate-300">
                  This application uses <strong>Google Gemini AI</strong> through your own API key. 
                  Your data processing by Google is subject to Google's Privacy Policy and Terms of Service. 
                  We recommend reviewing Google's policies regarding AI data processing.
                </p>
              </div>
            </div>
